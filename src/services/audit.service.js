...
export const AUDIT_ACTIONS = Object.freeze({
  ...
  ADMIN_CHATBOT_WIKI_CREATE: 'admin.chatbot_wiki.create',
  ADMIN_CHATBOT_WIKI_UPDATE: 'admin.chatbot_wiki.update',
  ADMIN_CHATBOT_WIKI_DELETE: 'admin.chatbot_wiki.delete',
