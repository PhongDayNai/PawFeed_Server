...
export const env = {
  ...
  provider: {
    name: process.env.PROVIDER_NAME || 'Pet Feeder Provider',
    brand: process.env.PROVIDER_BRAND || 'Pet Feeder IoT',
    website: process.env.PROVIDER_WEBSITE || 'https://example.com',
    contact: process.env.PROVIDER_CONTACT || 'support@example.com',
    note: process.env.PROVIDER_NOTE || 'Device configuration file generated by Pet Feeder Server.'
  },
